...
internal static partial class ModuleBootstrapperGenerator
{
    ...
    private static string BuildDeferredScriptPayload(string scriptPreamble, string scriptPayload)
    {
        ...
        builder.AppendLine("    $PowerForgeMergedScriptVariablesToRemove = @('PowerForgeMergedScriptAst', 'PowerForgeMergedScriptBuilder', 'PowerForgeMergedScriptContentStart', 'PowerForgeMergedScriptCursor', 'PowerForgeMergedScriptFirstSource', 'PowerForgeMergedScriptPayload', 'PowerForgeMergedScriptPayloadBase64', 'PowerForgeMergedScriptPreamble', 'PowerForgeMergedScriptRootReference', 'PowerForgeMergedScriptRootReferences', 'PowerForgeMergedScriptRootReplacement', 'PowerForgeMergedScriptSegment', 'PowerForgeMergedScriptSegments', 'PowerForgeMergedScriptSourceEnd', 'PowerForgeMergedScriptSourceEndMarker', 'PowerForgeMergedScriptSourceStart', 'PowerForgeMergedScriptSourceStartMarker')");
