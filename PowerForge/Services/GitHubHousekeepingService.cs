    ...
    public GitHubHousekeepingResult Run(GitHubHousekeepingSpec spec)
    {
        ...
        if (spec.Runner.Enabled)
        {
            var runnerResult = _runnerService.Clean(new RunnerHousekeepingSpec
            {
                ...
                DotNetRootPath = spec.Runner.DotNetRootPath,
                ...
                WorkspacesRetentionDays = spec.Runner.WorkspacesRetentionDays,
                ToolCacheRetentionDays = spec.Runner.ToolCacheRetentionDays,
                DotNetSdkVersionsToKeepPerMajorMinor = spec.Runner.DotNetSdkVersionsToKeepPerMajorMinor,
                DryRun = spec.DryRun,
                ...
                CleanWorkspaces = spec.Runner.CleanWorkspaces,
