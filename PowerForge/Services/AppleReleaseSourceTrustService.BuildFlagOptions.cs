...
internal sealed partial class AppleReleaseSourceTrustService
{
    ...
    {
        "--amdgpu-arch-tool", "--cuda-path", "--gpu-instrument-lib", "--hip-device-lib",
        "--hip-device-lib-path", "--hip-path", "--hipspv-pass-plugin", "--hipstdpar-path",
        ...
        "--nvptx-arch-tool", "--offload-arch-tool", "--ptxas-path", "--rocm-device-lib-path",
        "--rocm-path", "--source-metadata-list",
        "--gcc-install-dir", "--gcc-toolchain", "--sysroot", "--warning-suppression-mappings",
        ...
        "-fcodegen-data-use", "-fcuda-include-gpubinary", "-fdepscan-daemon", "-fembed-offload-object",
        "-fexperimental-sanitize-metadata-ignorelist", "-fmemory-profile-use",
        ...
        "-fopenmp-host-ir-file-path", "-fprofile-remapping-file", "-fprofile-sample-use", "-fprofile-use",
    ...
    private static readonly string[] BuildFlagPathPrefixes =
    {
        ...
        "--warning-suppression-mappings=", "--rocm-device-lib-path=", "--hip-device-lib-path=",
        "--hipstdpar-thrust-path=",
        "--hipstdpar-prim-path=", "--hipspv-pass-plugin=", "--source-metadata-list=",
        "--offload-arch-tool=", "--amdgpu-arch-tool=", "--nvptx-arch-tool=", "--gpu-instrument-lib=",
        "--hipstdpar-path=", "--hip-device-lib=", "--cuda-path=", "--hip-path=", "--ptxas-path=",
        "--gcc-install-dir=", "--gcc-toolchain=", "--rocm-path=", "--sysroot=",
        ...
        "-fdepscan-daemon=", "-fembed-offload-object=", "-fexperimental-sanitize-metadata-ignorelist=",
        "-fms-secure-hotpatch-functions-file=",
