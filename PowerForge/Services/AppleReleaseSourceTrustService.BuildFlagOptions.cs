...
internal sealed partial class AppleReleaseSourceTrustService
{
    ...
    private static readonly HashSet<string> BuildFlagPathOptions = new(StringComparer.Ordinal)
    {
        ...
        "-backup-module-interface-path", "-candidate-module-file", "-explicit-swift-module-map-file",
        ...
        "-frandomize-layout-seed-file", "-fsanitize-blacklist", "-fsanitize-coverage-allowlist",
        ...
        "-fthinlto-distributor", "-fxray-attr-list", "-gcc-toolchain", "-gen-cdb-fragment-path",
    ...
    private static readonly string[] BuildFlagPathPrefixes =
    {
        ...
        "-fsanitize-coverage-allowlist=", "-frandomize-layout-seed-file=",
