...
internal static class PowerShellTargetNativeAbiCatalog
{
    ...
    private static readonly HashSet<string> WindowsLibraries = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        "httpapi.dll", "iphlpapi.dll", "kernel32.dll", "mi.dll", "mimofcodec.dll", "msvcrt.dll", "mswsock.dll", "ncrypt.dll", "netapi32.dll", "normaliz.dll", "ntdll.dll", "ole32.dll",
        "oleaut32.dll", "powrprof.dll", "psapi.dll", "rpcrt4.dll", "secur32.dll", "shell32.dll", "shlwapi.dll", "sspicli.dll",
        "ucrtbase.dll", "user32.dll", "userenv.dll", "version.dll", "websocket.dll", "winhttp.dll", "winmm.dll", "wldap32.dll", "ws2_32.dll", "xolehlp.dll",
        // Microsoft.VisualBasic.Core uses these extensionless Windows loader names.
