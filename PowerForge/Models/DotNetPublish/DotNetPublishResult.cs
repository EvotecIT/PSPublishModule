...
public sealed class DotNetPublishArtefactResult
{
    ...
    /// <summary>Publisher-signed release evidence files emitted alongside a direct artifact.</summary>
    public string[] EvidencePaths { get; set; } = Array.Empty<string>();
...
public sealed class DotNetPublishMsiBuildResult
{
    ...
    /// <summary>Whether <see cref="ProjectPath"/> was generated by PowerForge for this build.</summary>
    public bool GeneratedProject { get; set; }
