...
public sealed class DotNetPublishPlan
{
    ...
    /// <summary>
    /// Configuration inputs generated by an authorized release wrapper after its clean-source preflight.
    /// These files remain checksum inputs but may be excluded from the later source-dirty snapshot.
    /// </summary>
    ...
    /// <summary>Explicit front-end request to avoid restore during both build and publish.</summary>
    internal bool SkipRestoreRequested { get; set; }
    ...
    /// <summary>Project release explicitly requested a separate build and no-build publish.</summary>
