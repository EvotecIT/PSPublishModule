...
/// <summary>
/// Input for the PowerForge Home Assistant release orchestrator.
/// </summary>
public sealed class HomeAssistantReleaseSpec {
    ...
    /// <summary>GitHub token used to inspect the merged pull request and publish the release.</summary>
    ...
    /// <summary>When true, create or resume the GitHub release after applying repository changes.</summary>
