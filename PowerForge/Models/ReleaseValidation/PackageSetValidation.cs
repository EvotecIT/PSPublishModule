...
public sealed class PackageSetValidation
{
    ...
    /// When false, consumer projects select individual versions and no release-wide version is inferred;
    /// module and tool probes use their own versions. Validation still requires the exact staged archives.</summary>
