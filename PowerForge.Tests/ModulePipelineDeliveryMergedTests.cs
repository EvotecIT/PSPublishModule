...
public sealed class ModulePipelineDeliveryMergedTests
{
    ...
    public void Run_MergedBinaryModule_InlinesScriptsAndExcludesSourceFoldersFromArtefact()
    {
        ...
        try
        {
            ...
            Assert.Contains("$LibraryName = 'TestModule'", stagingPsm1, StringComparison.Ordinal);
            Assert.Contains("$Library = 'TestModule.DLL'", stagingPsm1, StringComparison.Ordinal);
            Assert.Contains("$Root = @(", stagingPsm1, StringComparison.Ordinal);
