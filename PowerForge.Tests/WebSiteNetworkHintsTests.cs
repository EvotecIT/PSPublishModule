...
public class WebSiteNetworkHintsTests
{
    ...
    [Fact]
    public void Build_AddsMissingNetworkHintForExternalAssets()
    {
        ...
        try
        {
            ...
            Assert.DoesNotContain("<link rel=\"preconnect\" href=\"https://img.shields.io\"", html, StringComparison.Ordinal);
        }
        finally
        {
            Cleanup(root);
