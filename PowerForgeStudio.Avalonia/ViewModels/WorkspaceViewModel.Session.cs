...
public sealed partial class WorkspaceViewModel
{
    ...
    public string DisplayedStatus => HasStateError ? StateError : IsOverviewPage ? Overview.Status : IsHistoryPage ? History.DetailStatus : IsSettingsPage ? Settings.Status : IsActivityPage ? Activity.Status : IsStoragePage ? Storage.Status : IsAutomationsPage ? Automations.Status : IsConnectionsPage ? Connections.Status : Status;
