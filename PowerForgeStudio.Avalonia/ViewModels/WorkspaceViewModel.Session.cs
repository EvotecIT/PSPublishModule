...
public sealed partial class WorkspaceViewModel
{
    ...
    public string DisplayedStatus => HasStateError ? StateError : IsStoragePage ? Storage.Status : IsAutomationsPage ? Automations.Status : IsConnectionsPage ? Connections.Status : Status;
