...
public sealed class NavigationIcon : Control
{
    ...
    private static readonly IReadOnlyDictionary<string, Geometry> Shapes = new Dictionary<string, string>
    {
        ...
        ["branch"] = "M7,5 L7,19 M7,12 L13,12 Q18,12 18,7 M7,3 A2,2 0 1 0 7,7 A2,2 0 1 0 7,3 M7,17 A2,2 0 1 0 7,21 A2,2 0 1 0 7,17 M18,3 A2,2 0 1 0 18,7 A2,2 0 1 0 18,3",
        ...
        ["packages"] = "M3,7 L12,3 21,7 21,18 12,22 3,18 Z M3,7 L12,11 21,7 M12,11 L12,22 M8,5 L17,9",
        ...
        ["up"] = "M12,20 L12,4 M5,11 L12,4 19,11",
        ["file-new"] = "M5,3 L14,3 19,8 19,21 5,21 Z M14,3 L14,8 19,8 M10,14 L16,14 M13,11 L13,17",
        ["folder-new"] = "M3,7 L9,7 11,9 21,9 21,20 3,20 Z M3,11 L21,11 M12,13 L12,18 M9.5,15.5 L14.5,15.5",
        ["copy"] = "M8,7 L20,7 20,21 8,21 Z M5,17 L3,17 3,3 16,3 16,5",
        ["move"] = "M3,7 L9,7 11,9 20,9 20,20 3,20 Z M9,15 L18,15 M15,12 L18,15 15,18",
        ["rename"] = "M4,19 L7,19 18,8 15,5 4,16 Z M13,7 L16,10 M4,22 L21,22",
        ...
        ["restore"] = "M7,5 L19,5 19,17 M5,8 L16,8 16,20 5,20 Z",
