...
internal static partial class WebCliHelpers
{
    private static void PrintServerAndCloudflareUsage()
    {
        ...
        Console.WriteLine("  powerforge-web server scaffold --domain <domain> --repository <owner/repo> --engine-ref <sha> --host <host> --backup-repository <owner/repo> --backup-recipient <age1...> [--branch <name>] [--website-root <dir>] [--ssh-port <n>] [--site-id <id>] [--smoke-paths <paths>] [--private-repository] [--cloudflare] [--out <dir>] [--force] [--output json]");
