...
# Step 02 - Build module over and over again with different settings.
...
Build-Module -ModuleName 'MyGreatModule' -Path "C:\Support\GitHub" {
    ...
    New-ConfigurationDocumentation -Enable:$false -StartClean -UpdateWhenNew -PathReadme 'Docs\Readme.md' -Path 'Docs' -AboutTopicsSourcePath 'Help\About'

    New-ConfigurationImportModule -ImportSelf -ImportRequiredModules

    New-ConfigurationBuild -Enable:$true -SignModule:$false -DeleteTargetModuleBeforeBuild -MergeModuleOnBuild

    New-ConfigurationArtefact -Type Unpacked -Enable:$false -Path "$PSScriptRoot\..\Artefacts" -RequiredModulesPath "$PSScriptRoot\..\Artefacts\Modules"
    New-ConfigurationArtefact -Type Packed -Enable:$false -Path "$PSScriptRoot\..\Releases" -IncludeTagName
