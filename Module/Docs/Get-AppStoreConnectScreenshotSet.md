...
### __AllParameterSets
```powershell
Get-AppStoreConnectScreenshotSet -IssuerId <string> -KeyId <string> -VersionLocalizationId <string> [-PrivateKey <string>] [-PrivateKeyPath <string>] [-TokenLifetimeMinutes <int>] [-Limit <int>] [<CommonParameters>]
```
...
### EXAMPLE 1
```powershell
Get-AppStoreConnectScreenshotSet -IssuerId 'Value' -KeyId 'Value' -VersionLocalizationId 'Value'
```
