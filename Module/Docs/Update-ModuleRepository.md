...
```powershell
Update-ModuleRepository -MicrosoftArtifactRegistry [-Name <string>] [-Repository <string>] [-Tool <RepositoryRegistrationTool>] [-Trusted <bool>] [-Priority <int>] [-InstallPrerequisites] [-WhatIf] [-Confirm] [<CommonParameters>]
```
