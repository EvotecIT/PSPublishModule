...
### __AllParameterSets
```powershell
Get-AppStoreConnectGovernancePlan [-ConfigPath] <string> -IssuerId <string> -KeyId <string> [-PrivateKey <string>] [-PrivateKeyPath <string>] [-TokenLifetimeMinutes <int>] [<CommonParameters>]
```
