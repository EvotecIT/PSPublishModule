...
schema: 2.0.0
---
# Get-AppStoreConnectVersionLocalization
## SYNOPSIS
...
### __AllParameterSets
```powershell
Get-AppStoreConnectVersionLocalization -IssuerId <string> -KeyId <string> -VersionId <string> [-PrivateKey <string>] [-PrivateKeyPath <string>] [-TokenLifetimeMinutes <int>] [-Locale <string>] [-Limit <int>] [<CommonParameters>]
```
...
### EXAMPLE 1
```powershell
Get-AppStoreConnectVersionLocalization -IssuerId 'Value' -KeyId 'Value' -VersionId 'Value'
```
