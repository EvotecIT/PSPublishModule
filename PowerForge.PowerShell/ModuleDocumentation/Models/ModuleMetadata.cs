...
internal sealed class DocumentationModuleDependency
{
    ...
    public DocumentationDocumentationModuleDependencyKind Kind { get; set; } = DocumentationDocumentationModuleDependencyKind.Required;
    ...
    public List<DocumentationModuleDependency> Children { get; } = new List<DocumentationModuleDependency>();
}
...
internal sealed class ModuleInfoModel
{
    ...
    public List<DocumentationModuleDependency> Dependencies { get; } = new List<DocumentationModuleDependency>();
