...
internal static class PowerShellStatementErrorRuntimeSource
{
    internal static string Render()
    {
        ...
        foreach (var suffix in new[] { ".cs", ".Contract.cs", ".Exceptions.cs", ".Enumeration.cs", ".Finally.cs", ".Functions.cs", ".CommandRegions.cs", ".RegionSource.cs", ".Module.cs", ".Binding.cs", ".Variables.cs", ".NativeFunction.cs" })
        {
