...
internal static class PowerShellTypedExecutableEmitter
{
    ...
    internal static PowerShellTypedExecutableEmission Emit(string sourcePath, PowerShellCompilationPlan plan)
    {
        ...
        var method = new PowerShellCSharpMethodEmitter(sourcePath, ast, "<script>", "Invoke", statements).Emit();
