...
internal static class PowerShellCompilationFeatureCatalog
{
    internal static (string Title, string Recommendation) Describe(string featureId)
    {
        ...
        return featureId switch
        {
            ...
            PowerShellCompilationFeatureIds.CommentBasedHelp => ("Comment-based help", "Use the bounded runtime-free local Name/Synopsis view, generate external help for compiled cmdlets, or retain wider help-system behavior on a PowerShell path."),
