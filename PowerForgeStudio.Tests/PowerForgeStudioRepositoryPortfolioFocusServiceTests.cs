...
public sealed class PowerForgeStudioRepositoryPortfolioFocusServiceTests
{
    ...
    public void Filter_QueueActiveFocusWithSearch_ReturnsOnlyMatchingActionableRepositories()
    {
        var queueReady = CreateRepository(
            name: "PowerForgeStudio",
            rootPath: @"C:\Support\GitHub\PowerForgeStudio",
            readinessKind: RepositoryReadinessKind.Ready);
        ...
        Assert.Equal("PowerForgeStudio", item.Name);
    }
