...
/// <summary>
/// Options for generating static private gallery module pages.
/// </summary>
public sealed class WebPrivateGalleryPageOptions
{
    /// <summary>Private gallery feed JSON generated by private-gallery-index.</summary>
    public string PrivateGalleryPath { get; set; } = string.Empty;

    /// <summary>Optional portal docs JSON generated by portal-docs-index.</summary>
    public string? PortalDocsPath { get; set; }

    /// <summary>Output directory for generated module markdown pages.</summary>
    public string OutputDirectory { get; set; } = string.Empty;

    /// <summary>Optional base directory for resolving relative paths.</summary>
    public string? BaseDirectory { get; set; }

    /// <summary>Local repository profile name shown in generated install commands.</summary>
...
/// <summary>
/// Result returned by private gallery page generation.
/// </summary>
public sealed class WebPrivateGalleryPageResult
{
    /// <summary>Output directory for generated markdown pages.</summary>
    public string OutputDirectory { get; set; } = string.Empty;

    /// <summary>Number of module index pages generated.</summary>
    public int ModulePageCount { get; set; }

    /// <summary>Number of module document pages generated.</summary>
