...
internal static partial class Program
{
    ...
    private const string DotNetReleaseArtifactVerifyUsage =
        ...
        "       powerforge dotnet release-artifact verify --kind portable-cli --artifact-id <id> --project-root <path> --artifact <path> --checksums <SHA256SUMS.txt> --source-revision <sha> --manifest <manifest.json> --config <powerforge.dotnetpublish-or-release.json> [--version <x.y.z>] [--target <name>] [--rid <rid>] [--framework <tfm>] [--style <style>] [--signature-path <path>]* [--sbom <path>]* [--profile <name>] [--sign|--no-sign] [--sign-profile <name>] [--sign-thumbprint <sha1>] [--sign-subject-name <subject>] [--output json]\n" +
