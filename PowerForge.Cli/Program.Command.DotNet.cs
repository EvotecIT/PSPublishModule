...
internal static partial class Program
{
    ...
    private const string DotNetReleaseArtifactVerifyUsage =
        ...
        "       powerforge dotnet release-artifact verify --kind <portable-cli|powershell-module> --artifact-id <id> --project-root <path> --artifact <path> --checksums <SHA256SUMS.txt> --source-revision <sha> [--version <x.y.z>] [--manifest <manifest.json> --config <powerforge.dotnetpublish-or-release.json>] [--signing-evidence <module-signing.json>] [--target <name>] [--rid <rid>] [--framework <tfm>] [--style <style>] [--signature-path <path-or-archive-entry>]* [--sbom <path>]* [--profile <name>] [--sign|--no-sign] [--sign-profile <name>] [--sign-thumbprint <sha1>] [--sign-subject-name <subject>] [--output json]";
