...
internal static partial class Program
{
    ...
    private const string DotNetScaffoldUsage =
        "Usage: powerforge dotnet scaffold [--project-root <path>] [--project <App.csproj>] [--target <Name>] [--framework <tfm>] [--rid <Rid[,Rid...]>] [--style <Portable|PortableCompat|PortableSize|SelfContained|FrameworkDependent|AotSpeed|AotSize>[,...]] [--configuration <Release|Debug>] [--out <powerforge.dotnetpublish.json>] [--overwrite] [--no-schema] [--output json]";
    private const string DotNetReleaseArtifactVerifyUsage =
        "Usage: powerforge dotnet release-artifact verify --project-root <path> --manifest <manifest.json> --checksums <SHA256SUMS.txt> --config <powerforge.dotnetpublish-or-release.json> --installer <id> --source-revision <sha> (--sign-thumbprint <sha1>|--sign-subject-name <subject>) [--target <name>] [--rid <rid>] [--framework <tfm>] [--style <style>] [--artifact <manifest-relative-msi>] [--profile <name>] [--sign|--no-sign] [--sign-profile <name>] [--output json]\n" +
        "       powerforge dotnet release-artifact verify --kind portable-cli --artifact-id <id> --project-root <path> --artifact <path> --checksums <SHA256SUMS.txt> --source-revision <sha> --manifest <manifest.json> --config <powerforge.dotnetpublish-or-release.json> (--sign-thumbprint <sha1>|--sign-subject-name <subject>) [--version <x.y.z>] [--target <name>] [--bundle <id>] [--rid <rid>] [--framework <tfm>] [--style <style>] [--signature-path <path>]* [--sbom <path>]* [--profile <name>] [--sign|--no-sign] [--sign-profile <name>] [--output json]\n" +
        "       powerforge dotnet release-artifact verify --kind powershell-module --artifact-id <id> --project-root <path> --artifact <path> --checksums <SHA256SUMS.txt> --source-revision <sha> --signing-evidence <module-signing.json> (--sign-thumbprint <sha1>|--sign-subject-name <subject>) [--version <x.y.z[-prerelease]>] [--signature-path <archive-entry>]* [--sbom <path>]* [--output json]\n" +
        "       Each --sbom <path> requires a detached CMS signature at <path>.p7s from the exact admitted publisher certificate.";
