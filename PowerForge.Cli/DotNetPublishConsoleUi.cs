    ...
    private static string GetStepIcon(DotNetPublishStep step)
    {
        ...
        if (!unicode)
        {
            return step.Kind switch
            {
                ...
                DotNetPublishStepKind.DebianPackage => "[grey]DEB[/]",
                DotNetPublishStepKind.MacAppPackage => "[grey]APP[/]",
        ...
        return step.Kind switch
        {
            ...
            DotNetPublishStepKind.DebianPackage => "[yellow]📦[/]",
            DotNetPublishStepKind.MacAppPackage => "[yellow]🍎[/]",
