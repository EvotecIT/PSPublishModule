...
and Apple-silicon macOS CLI archives. The publish shortcut enables module signing with the certificate declared in
`powerforge.json`; use `-ModuleNoSign` only for an intentional unsigned release.
