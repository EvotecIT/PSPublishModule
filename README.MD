...
See [Docs\PSPublishModule.PrivateGalleries.md](Docs/PSPublishModule.PrivateGalleries.md) and `Get-Help about_PrivateGalleries` for the rollout checklist, PAT fallback guidance, and live Azure Artifacts validation helper with optional non-secret evidence JSON output.
