...
/// <summary>
/// Lightweight persisted token storage for PowerGuardian. Stores tokens per-host (GitHub/Azure DevOps)
...
internal static class TokenStore
{
    ...
    private static string SettingsPath
        => Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "PowerGuardian", "settings.json");
