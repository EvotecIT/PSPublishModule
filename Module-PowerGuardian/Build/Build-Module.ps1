Build-Module -ModuleName 'PowerGuardian' {
    ...
    $newConfigurationBuildSplat = @{
        ...
        NETProjectPath                    = "$PSScriptRoot\..\..\Sources\PowerGuardian"
        ResolveBinaryConflicts            = $true
        ResolveBinaryConflictsName        = 'PowerGuardian'
        NETProjectName                    = 'PowerGuardian'
        NETBinaryModule                   = 'PowerGuardian.dll'
