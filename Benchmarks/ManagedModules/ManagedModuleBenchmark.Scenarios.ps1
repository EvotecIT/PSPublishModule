...
function Get-ScenarioCatalog {
    @(
        ...
        New-BenchmarkScenario -SuiteName 'HeavySaveGate' -Name 'Az.Full.Save' -ModuleName 'Az' -Version '16.0.0' -AcceptLicense $true -Operations @('Save') -Engines @('Managed', 'ModuleFast', 'PSResourceGet', 'PowerShellGet') -ScenarioManagedMaxRank 1
        ...
        New-BenchmarkScenario -SuiteName 'SaveGate' -Name 'Graph.Authentication.Save' -ModuleName 'Microsoft.Graph.Authentication' -AcceptLicense $true -Operations @('Save') -Engines @('Managed', 'ModuleFast', 'PSResourceGet', 'PowerShellGet') -ScenarioManagedMaxRank 1
    )
}
