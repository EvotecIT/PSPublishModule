...
Run the Az provider matrix. `Az.Accounts.ProviderMatrix` is the shorter proof lane; `Az.Full.ProviderMatrix` is the heavyweight row for the full Az module family:
