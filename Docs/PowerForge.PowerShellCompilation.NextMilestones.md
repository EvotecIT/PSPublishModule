...
- [ ] Choose recurring blocker families by the portfolio's shared semantic shapes, effects, ownership, and lifetime. Current evidence covers **17/30 newly executed complete functions** across four module packets and three families: native indexed targets, dynamic format templates, and bounded source closure. Continue until at least **30 newly executed complete functions across at least three distinct module packets**, including an Evotec module other than PSSharedGoods and a third-party module, are qualified across at least four recurring families. No single module may supply more than half of the 30. Count each function once against its own fixed baseline; partial regions and unexecuted emitted functions do not count.
