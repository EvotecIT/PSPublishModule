...
The first complete-workflow qualification set is fixed below. None has passed its execution gate yet. Keep the authored function intact; compiler improvements must apply to its general language contracts. Analyze both command and runtime-free targets because their blockers differ.
