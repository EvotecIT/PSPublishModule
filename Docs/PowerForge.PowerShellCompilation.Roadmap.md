...
| [28. Source-first development loop](PowerForge.PowerShellCompilation.NextMilestones.md#milestone-28--deliver-a-source-first-development-loop) | Current | Run, incremental rebuild, explain, and observed source-level debugging use the existing project service |
| [29. Distribution and qualified platforms](PowerForge.PowerShellCompilation.NextMilestones.md#milestone-29--qualify-distribution-providers-and-platforms) | Partial / external gates | M19/M21/M22 close for the declared release set and actual supported targets |
...
1. [ ] Deliver M28 run/watch/diagnose/debug through the existing project, cache, diagnostics, source-map, and package owners. Failed rebuilds must not silently execute stale outputs.
...
- [x] Complete corrective full-gate, Strict corpus, and final fixture requalification; M28 is the next development milestone.
- [ ] Complete M28 run/watch/diagnose/debug and M29 host-servicing/release qualification through the existing owners; M30 follows with measured workflow benefit.
