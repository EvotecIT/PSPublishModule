...
16. [ ] Continue M24 by qualifying ordered-map key enumeration together with dictionary construction, identity, escape, and streamed record behavior in unchanged `Get-ProtocolDefaults`; keep independent indexed-output and note-property blockers separate.
