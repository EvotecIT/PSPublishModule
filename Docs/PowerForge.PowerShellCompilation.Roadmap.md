...
14. [ ] Inventory the four foreach-only residuals and implement the largest lazy-enumeration contract they genuinely share rather than admitting arbitrary enumerators.
