...
- [x] Pass the complete compiler category: 877/877 tests on .NET 10, including generated `net10.0`/PowerShell 7.6 and `net472`/Windows PowerShell 5.1 artifact cases.
