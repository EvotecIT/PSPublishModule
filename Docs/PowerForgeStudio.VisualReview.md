...
| Activity catalog | Totals lead the page, provider availability remains visible in a compact strip, and full source evidence expands below the actionable list. Wide and compact headless renders show the earlier list start. | Keep the compact inspector readable when provider explanations are long. |
