...
- [ ] Close the remaining PowerShell 7 `Microsoft.Graph.Authentication` save gap where managed is near parity but still trails PSResourceGet by about 3 percent in the latest one-shot run.
