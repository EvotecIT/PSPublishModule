...
- [ ] Run the full `Az` no-op/force heavy lifecycle gate on PowerShell 7, then inspect managed rank and phase bottlenecks before making a full-family lifecycle claim.
