...
- [ ] Run the heavy full-family Graph/Az no-op/force gates repeatedly on PowerShell 7, then inspect managed rank and phase bottlenecks before making a full-family lifecycle claim.
