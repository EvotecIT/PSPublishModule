...
- [ ] Promote repeated `Microsoft.Graph.Authentication` save comparisons into the benchmark suite as a stability gate for both PowerShell 7 and Windows PowerShell 5.1.
