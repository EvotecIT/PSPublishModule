...
- [ ] Decide whether the next full Az proof should be managed-only repeated stability, a default-source provider comparison, or a same-source rerun after provider/source behavior changes.
