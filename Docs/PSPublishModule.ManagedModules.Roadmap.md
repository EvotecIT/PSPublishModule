...
- [ ] Close the remaining PowerShell 7 `Microsoft.Graph.Authentication` save gap where managed is near parity but still trails PSResourceGet by roughly 5-6 percent in the latest repeated rotated run.
