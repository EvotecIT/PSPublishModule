@{
    ...
    FunctionsToExport    = @('Convert-CommandsToList', 'Get-GitLog', 'Get-MissingFunctions', 'Initialize-PortableModule', 'Initialize-PortableScript', 'Initialize-ProjectManager', 'New-PrepareModule', 'Register-Certificate', 'Remove-Comments', 'Test-BasicModule', 'Test-ScriptFile', 'Test-ScriptModule')
