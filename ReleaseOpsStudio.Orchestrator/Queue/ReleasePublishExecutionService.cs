...
public sealed partial class ReleasePublishExecutionService
{
    private async Task<ProjectReleasePlan?> GenerateProjectPlanAsync(ReleaseOpsStudio.Domain.Catalog.RepositoryCatalogEntry repository, CancellationToken cancellationToken)
    {
...
public sealed partial class ReleasePublishExecutionService
{
    private async Task<IReadOnlyList<ReleasePublishReceipt>> ExecuteModulePublishAsync(
        ReleaseOpsStudio.Domain.Catalog.RepositoryCatalogEntry repository,
        ReleaseSigningExecutionResult signingResult,
        CancellationToken cancellationToken)
    {
