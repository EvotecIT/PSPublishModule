...
using ReleaseOpsStudio.Orchestrator.Catalog;
...
public sealed class ReleaseBuildExecutionService
{
    ...
    private async Task<ReleaseBuildAdapterResult> ExecuteProjectBuildAsync(ReleaseOpsStudio.Domain.Catalog.RepositoryCatalogEntry repository, CancellationToken cancellationToken)
    {
    ...
    private async Task<ReleaseBuildAdapterResult> ExecuteModuleBuildAsync(ReleaseOpsStudio.Domain.Catalog.RepositoryCatalogEntry repository, CancellationToken cancellationToken)
    {
